...
class Book {
    ...
    get license() {
        // TODO: Remove this after https://jira.nyu.edu/jira/browse/NYUP-737 is fixed.
        let nyup737TemporaryWorkaroundLicenseName = this.book.custom.license_name;
        if ( nyup737TemporaryWorkaroundLicenseName === 'Creative Commons Attribution-NonCommercial-NoDerivs-4.0-International-Public-License' ) {
            nyup737TemporaryWorkaroundLicenseName = 'Creative Commons Attribution-NonCommercial-NoDerivatives 4.0 International License';
        } else if ( nyup737TemporaryWorkaroundLicenseName === 'Creative Commons Attribution-NonCommercial-ShareAlike-4.0-International-Public-License' ) {
            nyup737TemporaryWorkaroundLicenseName = 'Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License';
        } else {
            // Just pick one.
            nyup737TemporaryWorkaroundLicenseName = 'Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License';
        }
        ...
        return {
            name : nyup737TemporaryWorkaroundLicenseName,
        };
    }
