...
class Supafolio {
    ...
    book( epubId ) {
        ...
        if ( response.statusCode !== 200 ) {
            throw Supafolio.#newSupafolioHttpError( response );
        }
    ...
    static #newSupafolioHttpError( response ) {
        return new SupafolioHttpError( response.statusCode, response.body.toString() );
    }
}
