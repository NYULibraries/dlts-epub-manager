...
class Supafolio {
    ...
    static #newSupafolioAPIError( response ) {
        ...
        switch ( message ) {
            case SupafolioAPIProductNotInDatabaseError.MESSAGE :
                return new SupafolioAPIProductNotInDatabaseError();
            case SupafolioAPIResourceNotFoundError.MESSAGE :
                return new SupafolioAPIResourceNotFoundError();
            default :
