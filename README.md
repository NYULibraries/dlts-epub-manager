...
* Intake of EPUB files and publisher-provided metadata: creation of the normalized,
...
* Solr indexing of EPUB metadata from the source files generated by intake
...
somebody@host:~/epub-manager$ ./em help
  ...
  Commands:
    ...
    intake add [configuration]                 Intake EPUBs and generate Readium versions and associated metadata
                                               files.
